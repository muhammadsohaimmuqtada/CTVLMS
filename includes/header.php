    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav me-auto mb-2 mb-xl-0">
                <li class="nav-item">
                    <a class="nav-link <?= navActive('dashboard') ?>" href="?page=dashboard"><i class="bi bi-speedometer2"></i> Dashboard</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?= navActive('assets') || navActive('vulnerabilities') || navActive('asset_vulns') || navActive('exposures') ? 'active' : '' ?>"
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark">
                        ...
                        <li><a class="dropdown-item" href="?page=exposures/list"><i class="bi bi-radar"></i> Exposure Intelligence</a></li>
                ...
                <li class="nav-item">
                    <a class="nav-link <?= navActive('reports') ?>" href="?page=reports"><i class="bi bi-file-earmark-bar-graph"></i> Reports</a>
                </li>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <a href="?page=logout" class="btn btn-outline-danger btn-sm" title="Logout"><i class="bi bi-box-arrow-right"></i></a>
            </div>
        </div>
    </div>
</nav>
